...
FunctionsToExport = 'Write-CMLog', 'Get-Translit', 'Convert-StringToHex', 'Get-Hex', 
               'Get-IASLog', 'New-IPScope', 'Get-ADParent', 'Get-QWinSta', 
               'Test-GroupMembership', 'Write-Log', 'Wait-Reboot', 'Get-ADUserByName', 
               'New-ShadowConnection', 'Update-ModuleVersion', 'Get-LockSource', 
               'Test-Port', 'Get-LoggedInUsers', 'ConvertTo-Encoding', 
               'Test-EmailValidation', 'Invoke-Process', 'Convert-HexToString', 
               'Connect-DWClient', 'Get-BPStagingQuota', 'New-Password', 
               'Update-ScriptVersion', 'Get-LogonServer', 'Get-NetUserDomain', 
               'Connect-VNCClient', 'Send-WOL', 'Import-Excel', 
               'Get-IPAddressCalculation', 'Get-MyInventoryInfo', 
               'Get-PasswordExperationDate', 'Get-ADSiteServer', 'Get-UserGroups', 
               'Restart-Server', 'Connect-ExchangeServer', 'New-TestFile', 
               'Get-ResizedPicture', 'Limit-String', 'Export-Excel', 'Unblock-RDP'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '1.13.0.41 (06.09.2021): Classes are in separate file now.
Invoke-Process added
