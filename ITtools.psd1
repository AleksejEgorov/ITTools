#
# Module manifest for module 'ITtools'
#
# Generated by: Aleksej Egorov
#
# Generated on: 19.09.2021
#
...
NestedModules = @('.\ITTools_Logging.psm1', 
               '.\ITTools_FileProcessing.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Update-ScriptVersion', 'Test-EmailValidation', 'Test-Port', 
               'Update-ModuleVersion', 'Get-ResizedPicture', 'Connect-DWClient', 
               'Test-GroupMembership', 'New-ShadowConnection', 'Convert-StringToHex', 
               'Send-WOL', 'Unblock-RDP', 'Wait-Reboot', 'Convert-HexToString', 
               'Get-QWinSta', 'Get-ADParent', 'Get-NetUserDomain', 
               'Get-IPAddressCalculation', 'Get-LoggedInUsers', 
               'Get-PasswordExperationDate', 'Invoke-Process', 'Get-ADUserByName', 
               'Get-BPStagingQuota', 'Get-Hex', 'New-Password', 'Import-Excel', 
               'Connect-VNCClient', 'Get-LockSource', 'New-IPScope', 'Get-UserGroups', 
               'Export-Excel', 'Get-InventoryInfo', 'Limit-String', 'Get-ADSiteServer', 
               'Restart-Server', 'Get-Translit', 'ConvertTo-Encoding', 
               'Connect-ExchangeServer', 'Get-LogonServer', 'Get-IASLog', 'Write-Log', 
               'Write-CMLog', 'Limit-FileSize', 'Remove-OldFiles', 'New-TestFile'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '1.13.6.47 (19.09.2021): Write-CMLog: Encoding fixed
